...
- [Robotics](${path("/robotics")}): FIRST Robotics teams from kindergarten through high school. Four levels: LEGO League Explore (Grades K–3), LEGO League Challenge (Grades 4–8), FIRST Tech Challenge / FTC (Grades 7–12), FIRST Robotics Competition / FRC (Grades 9–12, Highlander Robotics Teams 8033 and 8433).
